    ...
    <footer className="bg-[#0A0A0A] text-neutral-400">
      <div className="max-w-[1440px] mx-auto px-4 md:px-6 py-14 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-12">
          <div className="lg:col-span-2">
            ...
            <p className="text-sm leading-relaxed max-w-sm mb-6">
              {isRTL
                ? 'منصة الخياطة الذكية للرجال والأطفال — تفصيل، أقمشة، وتتبع في ثلاث خطوات.'
                : 'Smart tailoring for men and boys — tailoring, fabrics, and tracking in three steps.'}
            </p>
            <p className="text-xs text-neutral-500">+966 55 123 4567 · info@mufasal.com</p>
          </div>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col sm:flex-row justify-between gap-4 text-xs text-neutral-500">
          <span>© {year} {isRTL ? 'مفصل. جميع الحقوق محفوظة.' : 'MUFASAL. All rights reserved.'}</span>
