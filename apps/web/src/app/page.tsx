...
const fashionModels = [
  { titleAr: 'الثوب الكلاسيكي', titleEn: 'Classic Thobe', tagAr: 'تميز بأصالتك', tagEn: 'Heritage Style', h: 'h-[420px]', grad: 'from-[#00373E] via-[#00565f] to-[#001a1d]', img: 'https://i.pinimg.com/736x/cf/f5/9b/cff59bbca0482ad3c322f686ab59cf13.jpg' },
  { titleAr: 'أناقة الشماغ', titleEn: 'Shemagh Elegance', tagAr: 'هوية خليجية', tagEn: 'Gulf Identity', h: 'h-[300px]', grad: 'from-[#481719] via-[#6b2022] to-[#1a0305]', img: 'https://i.pinimg.com/736x/c8/e4/b3/c8e4b3d002046f0d3e2647ee24321f54.jpg' },
  { titleAr: 'البساطة الراقية', titleEn: 'Refined Simplicity', tagAr: 'فخامة في البساطة', tagEn: 'Luxe Minimal', h: 'h-[360px]', grad: 'from-[#735B4D] via-[#8a6e5e] to-[#2a1f18]', img: 'https://i.pinimg.com/736x/1e/a1/fc/1ea1fc882397c37dd9c6dbdefc05bbf3.jpg' },
  { titleAr: 'ليلة الفخامة', titleEn: 'Luxury Night', tagAr: 'إطلالة مميزة', tagEn: 'Statement Look', h: 'h-[340px]', grad: 'from-[#0a0a0a] via-[#1a1205] to-[#2d2000]', img: 'https://i.pinimg.com/736x/71/7e/1b/717e1b58eafdfa685b7a348291e16a36.jpg' },
  { titleAr: 'البشت الملكي', titleEn: 'Royal Bisht', tagAr: 'شموخ وكبرياء', tagEn: 'Regal Pride', h: 'h-[400px]', grad: 'from-[#2d1f00] via-[#4a3500] to-[#1a0a00]', img: 'https://i.pinimg.com/736x/c6/b1/bd/c6b1bdda23531ada4d1006271b5d8f32.jpg' },
  { titleAr: 'لحظة الرقي', titleEn: 'Elegant Moment', tagAr: 'تفاصيل لا تُنسى', tagEn: 'Unforgettable Details', h: 'h-[280px]', grad: 'from-[#00373E] via-[#003030] to-[#000d0e]', img: 'https://i.pinimg.com/736x/0f/29/e3/0f29e3ec2866331b5ef9722d599f7afa.jpg' },
  { titleAr: 'هيبة الكبار', titleEn: 'Distinguished Elegance', tagAr: 'وقار يتحدث', tagEn: 'Quiet Authority', h: 'h-[320px]', grad: 'from-[#1a1a2e] via-[#16213e] to-[#0a0a18]', img: 'https://i.pinimg.com/736x/f9/b2/3c/f9b23c5addb8ed98b340847bdb689ae2.jpg' },
  { titleAr: 'روح الوطن', titleEn: 'Homeland Spirit', tagAr: 'فخر الانتماء', tagEn: 'Pride of Identity', h: 'h-[380px]', grad: 'from-[#006b3c] via-[#004d2b] to-[#001a0e]', img: 'https://i.pinimg.com/736x/06/80/2b/06802b1d39d9c5501079d4fe41965f43.jpg' },
  { titleAr: 'جيل الطموح', titleEn: 'Generation Aspire', tagAr: 'شباب بنكهة أصيلة', tagEn: 'Youth & Heritage', h: 'h-[300px]', grad: 'from-[#481719] via-[#2d0e10] to-[#0a0304]', img: 'https://i.pinimg.com/736x/8e/04/8f/8e048fe5e036946dcfcb19065fc08af1.jpg' },
  { titleAr: 'التميز المعاصر', titleEn: 'Contemporary Excellence', tagAr: 'عصري بلمسة كلاسيك', tagEn: 'Modern Classic', h: 'h-[350px]', grad: 'from-[#735B4D] via-[#4a3020] to-[#1a0a00]', img: 'https://i.pinimg.com/736x/32/6e/12/326e12e74c608cc8e3c7be603bcd831d.jpg' },
