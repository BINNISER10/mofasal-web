...
export default function DashboardLayout({
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F5] dark:bg-slate-900" dir={isRTL ? 'rtl' : 'ltr'}>
      <Sidebar
        isOpen={sidebarOpen}
      ...
      <div className={cn('transition-all duration-300', isRTL ? 'lg:mr-64' : 'lg:ml-64')}>
        {/* Header */}
        <header className="sticky top-0 z-30 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border-b border-[#D0D6D7]/50 dark:border-slate-800 shadow-[0_1px_3px_rgba(0,55,62,0.06)]">
          <div className="flex items-center justify-between px-4 md:px-6 h-16">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-bold text-[#00373E] dark:text-slate-100">{getDashboardTitle()}</h1>
              </div>
              {roleBadge.label && (
                  ...
                  <>
                    ...
                    <div className={cn(
                      ...
                      <div className="px-4 py-3 border-b border-[#D0D6D7]/30">
                        <p className="text-sm font-semibold text-[#00373E] dark:text-slate-200">{user?.name}</p>
                        <p className="text-xs text-[#735B4D]/60 dark:text-slate-500">{user?.email}</p>
                      </div>
                      ...
                      >
                        <User size={16} className="text-[#735B4D]" />
              ...
              <div className="flex items-center gap-1.5 text-xs">
                {breadcrumbs.map((crumb, i) => (
                  <React.Fragment key={crumb.path}>
                    {i > 0 && (
                      isRTL ? <ChevronLeft size={12} className="text-[#735B4D]/30" /> : <ChevronRight size={12} className="text-[#735B4D]/30" />
                    )}
