...
export default function MouPage() {
  return (
    <div className="min-h-screen bg-[#F2E8D4] text-[#1A1A1A]" dir="rtl">
      {/* Cover */}
      <section className="min-h-[90vh] bg-[#00373E] text-white flex flex-col items-center justify-center px-6 text-center print:min-h-screen print:break-after-page">
        <Image src="/images/logo.png" alt="مفصل" width={120} height={120} className="mb-8 rounded-2xl" />
      ...
      <section className="py-16 px-6 max-w-5xl mx-auto print:break-after-page">
        ...
        <p className="text-[#735B4D] mb-8 text-sm">لقطات حية من النسخة التشغيلية — يُرفق الملف الكامل في حزمة المستثمر</p>
      ...
      <section className="px-6 max-w-4xl mx-auto pb-16 space-y-8">
        ...
        {/* Signatures */}
        <div className="bg-[#00373E] text-white rounded-2xl p-8 print:break-before-page">
          <h3 className="text-xl font-black mb-6 text-center">التوقيع والاعتماد</h3>
          <div className="grid md:grid-cols-2 gap-6">
            {MOU_PARTIES.map((p) => (
              <div key={p.id} className="border border-white/20 rounded-xl p-4">
      ...
      <footer className="print:hidden sticky bottom-0 bg-white/90 backdrop-blur border-t border-[#00373E]/10 p-4 flex flex-wrap gap-3 justify-center">
        <PrintButton />
        <Link href="/investor" className="px-6 py-3 rounded-xl border border-[#00373E] text-[#00373E] font-bold text-sm">
          حزمة المستثمر
        </Link>
      </footer>
    </div>
