  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center p-6">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-xl font-black text-gray-900 mb-2">تعذر تحميل السوق</h2>
        <p className="text-gray-500 text-sm leading-relaxed mb-6">حدث خطأ أثناء تحميل سوق الأقمشة. يرجى المحاولة مرة أخرى.</p>
        <div className="flex items-center justify-center gap-3">
          ...
          <button onClick={() => router.push('/marketplace')} className="flex items-center gap-2 px-5 py-2.5 border border-gray-200 text-gray-700 bg-white rounded-xl font-semibold text-sm hover:bg-gray-50 transition-colors"><ShoppingBag size={16} />السوق</button>
        </div>
      </div>
    </div>
  );
