...
export const DEMO_SHOPS = [
  {
    ...
    logo: '/images/sections/category-tailoring.png',
    coverImage: '/images/sections/shops-hero.png',
    ownerId: 'demo-tailor',
  ...
  },
  {
    ...
    logo: '/images/sections/category-fabric.png',
    coverImage: '/images/sections/marketplace-hero.png',
...
export const DEMO_PRODUCTS = [
  {
    ...
    minStock: 5,
    category: 'أقمشة',
    images: ['/images/sections/fabric-silk-white.png'],
  ...
  },
  {
    ...
    minStock: 10,
    category: 'أقمشة',
    images: ['/images/sections/fabric-cream-flow.png'],
    merchantId: 'demo-merchant',
    merchantName: 'بيت الأقمشة الفاخرة',
    isActive: true,
    isFeatured: true,
  ...
  {
    id: 'prod-4',
    name: 'قماش بدلة رسمية',
    nameAr: 'قماش بدلة رسمية',
    nameEn: 'Formal Suit Fabric',
    description: 'صوف مربعات للبدلة الرسمية',
    descriptionAr: 'صوف مربعات للبدلة الرسمية',
    price: 220,
    stock: 35,
    minStock: 5,
    category: 'أقمشة',
    images: ['/images/sections/fabric-suit-fold.png'],
    merchantId: 'demo-merchant',
    merchantName: 'بيت الأقمشة الفاخرة',
    isActive: true,
    isFeatured: true,
